 ...
 *
 * class TransactionMetricsHook implements ITransactionHooks {
 ...
 *   }
 *
 *   async onCommitRetry(context: ITransactionContext, attempt: number, error: Error): Promise<void> {
...
export interface ITransactionHooks {
     ...
     *
     * @param context - Transaction context with metadata
     *
     * @example
     * ```typescript
     ...
     * @example
     * ```typescript
     * async beforeCommit(context: ITransactionContext): Promise<void> {
     *   // Log commit attempt
     ...
     * ```
     */
    onCommitRetry?(context: ITransactionContext, attempt: number, error: Error): Promise<void>;
     ...
     * @example
     * ```typescript
     * async beforeRollback(context: ITransactionContext, reason: Error): Promise<void> {
     *   this.logger.error(
