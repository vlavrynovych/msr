---
layout: default
title: v0.2 to v0.3 Migration Guide
...
Three logger implementations are now available:

```typescript
import { ConsoleLogger, SilentLogger, FileLogger } from '@migration-script-runner/core';
...
### 2. Structured Migration Results
