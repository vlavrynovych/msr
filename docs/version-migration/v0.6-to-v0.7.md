...
- 🖥️ **CLI Factory** - Create command-line interfaces with built-in commands (migrate, list, down, validate, backup) - see [CLI Adapter Development Guide](../guides/cli-adapter-development)
