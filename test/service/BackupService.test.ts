...
describe('BackupService', () => {
    ...
    it('backup: should log success message with file path', async () => {
        // having
        const cfg = new Config();
        cfg.backup.timestamp = false;
    ...
    it('restore: should log restoration messages', async () => {
        // having
        const cfg = new Config();
        cfg.backup.timestamp = false;
    ...
    it('prepareFilePath: should handle custom backup configuration', () => {
    ...
    it('prepareFilePath: should format timestamp correctly', () => {
        // having
        const cfg = new BackupConfig();
        cfg.timestamp = true;
